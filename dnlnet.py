import paddle
from paddleseg.models import DNLNet
...
model = DNLNet(num_classes=5,backbone=backbone)
...
base_lr = 0.01
lr = paddle.optimizer.lr.PolynomialDecay(base_lr, power=0.9, decay_steps=40000, end_lr=0.00001)
