import paddle
from paddleseg.models import DANet
...
model = DANet(num_classes=5,backbone=backbone,backbone_indices=(2,3))
...
losses = {}
losses['types'] = [CrossEntropyLoss()] *4
losses['coef'] = [1] *4
# 训练
train(
    model=model,
